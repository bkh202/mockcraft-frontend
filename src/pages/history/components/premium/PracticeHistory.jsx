        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <div>
            ...
            >
              ...
              <option value="OOPS & Programming">OOPS</option>
              <option value="DSA">DSA</option>
              <option value="Engineering Drawing">ED</option>
            </select>
          </div>
              ...
              <div className="flex items-start justify-between mb-3">
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${q.correct
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm text-gray-600">of {questionTotalPages}</span>
            </div>
            ...
            <div className="mt-4 flex justify-center">
              <div className="flex space-x-1">
                {Array.from({ length: Math.min(5, questionTotalPages) }, (_, i) => {
                  let pageNum;
                  if (questionTotalPages <= 5) {
                    pageNum = i;
                  } else if (questionPage < 2) {
                    pageNum = i;
                  } else if (questionPage > questionTotalPages - 3) {
                    pageNum = questionTotalPages - 5 + i;
                  } else {
                    pageNum = questionPage - 2 + i;
                  }
                  ...
                  return (
                    <button
                      ...
                      className={`w-8 h-8 rounded-md text-sm font-medium transition-colors ${questionPage === pageNum
