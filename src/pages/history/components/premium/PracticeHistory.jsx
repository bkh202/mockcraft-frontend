...
const BRANCH_DATA = {
  CSE: {
    ...
    subjects: ["Data Structures", "Algorithms", "Operating Systems", "DBMS", "Computer Networks", "System Design", "JavaScript", "React", "Python", "Java", "OOPS & Programming"],
  },
  EE: {
    label: "Electrical Engineering (EE)",
    subjects: ["Circuit Theory", "Power Systems", "Electrical Machines", "Control Systems", "Power Electronics", "Signals & Systems"],
  },
  ECE: {
    label: "Electronics & Communication (ECE)",
    subjects: ["Analog Electronics", "Digital Electronics", "Communication Systems", "VLSI Design", "Microprocessors", "Embedded Systems"],
  },
  MECH: {
    label: "Mechanical Engineering",
    subjects: ["Thermodynamics", "Fluid Mechanics", "Strength of Materials", "Manufacturing", "Theory of Machines", "Heat Transfer"],
  },
  CIVIL: {
    label: "Civil Engineering",
    subjects: ["Structural Analysis", "Geotechnical Engineering", "Fluid Mechanics", "Environmental Engineering", "Construction Materials", "Surveying"],
  },
};
...
const PracticeHistory = ({
  ...
  const handleBranchChange = (branch) => {
    ...
    onFilterChange('subject', ''); // reset subject on branch change
  };

  const currentSubjects = BRANCH_DATA[selectedBranch].subjects;

  return (
    <div className="bg-white rounded-xl shadow-sm p-6 border">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6">
        <h2 className="text-xl font-semibold text-gray-900 mb-2 sm:mb-0">Practice History</h2>
      ...
      <div className="mb-4 p-4 bg-gray-50 rounded-lg">
        ...
        <p className="text-xs text-gray-400 mt-1">{BRANCH_DATA[selectedBranch].label}</p>
      </div>
        ...
        {questions.length > 0 ? (
          ...
          <div className="text-center py-12">
            ...
            {(filters.category || filters.subject || filters.difficulty) && (
              <button onClick={onClearFilters} className="mt-2 text-blue-600 hover:text-blue-800 text-sm">
                Clear filters
              </button>
            )}
          </div>
                  ...
                  return (
                    <button
                      ...
                      className={`w-8 h-8 rounded-md text-sm font-medium transition-colors ${
                        questionPage === pageNum ? 'bg-blue-600 text-white' : 'text-gray-700 hover:bg-gray-100'
                      }`}
                    >
                      {pageNum + 1}
                    </button>
