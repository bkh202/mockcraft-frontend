        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center">
            ...
            <Link to="/analyzer/upload" className="flex items-center gap-3">
              ...
              <div className="hidden md:block">
                <h1 className="text-xl font-black bg-gradient-to-r from-teal-500 to-emerald-500 bg-clip-text text-transparent">
                  AI Analyzer
                </h1>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              ...
              >
                <div className="w-9 h-9 rounded-full bg-gradient-to-br from-teal-100 to-emerald-100 dark:from-teal-900/50 dark:to-emerald-900/50 flex items-center justify-center text-teal-700 dark:text-teal-400 font-black border border-teal-200 dark:border-teal-800">
              ...
              {showProfileMenu && (
                <div className="absolute right-0 mt-2 w-64 bg-white dark:bg-slate-800 rounded-xl shadow-xl border border-slate-100 dark:border-slate-700 py-2 z-50">
                  ...
                  <div className="p-2">
                    <button onClick={() => navigate('/portfolio/dashboard')} className="flex items-center gap-3 w-full px-3 py-2 text-sm text-slate-700 dark:text-slate-300 font-bold hover:bg-slate-50 dark:hover:bg-slate-700 rounded-lg transition-colors">
                      💼 Back to Portfolio
                    </button>
