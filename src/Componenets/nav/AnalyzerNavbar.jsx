...
export default function AnalyzerNavbar() {
  ...
  const navLinks = [
    { label: "New Scan", icon: "fa-bolt", path: "/resume-analyzer" },
    { label: "Scan History", icon: "fa-folder-open", path: "/analyzer/history" },
    { label: "AI Interview", icon: "fa-microphone", path: "/ai-mock-interview" },
    { label: "Pro Plans", icon: "fa-crown", path: "/pricing" },
  ];
                ...
                <div className="absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-xl border border-gray-200 py-2 z-50">
                  ...
                  <div className="p-2">
                    <button
                      ...
                      className="flex items-center gap-3 w-full px-3 py-2 text-base font-medium text-gray-700 hover:text-black hover:bg-gray-100 rounded-lg transition-colors"
                    >
                    ...
                    <button
                      ...
                      className="flex items-center gap-3 w-full px-3 py-2 text-base font-medium text-black hover:bg-gray-100 rounded-lg transition-colors mt-1"
                    >
